    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-8">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h1 className="text-4xl font-medium tracking-tight text-white">System Configuration</h1>
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="card-premium relative overflow-hidden group border border-[#E0E5F2]/50">
                        ...
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="text-2xl font-medium flex items-center gap-3 text-white">
                                <RefreshCw className="w-6 h-6 text-blue-400" />
                                Exchange Currency
                            </h2>
                            <span className="text-[10px] bg-blue-500/10 text-blue-400 border border-blue-500/20 px-3 py-1.5 rounded-lg font-medium uppercase tracking-[0.2em]">Global Sync</span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                            <div className="bg-[#F4F7FE] border border-[#E0E5F2] p-4 rounded-lg hover:border-primary/30 transition-all group/input">
                                <span className="text-[11px] text-slate-500 font-medium uppercase tracking-[0.2em] mb-4 block ml-1">Current Multiplier</span>
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-primary/10 rounded-lg text-primary">
                                        <DollarSign className="w-6 h-6" />
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-[10px] text-slate-600 font-medium uppercase tracking-tighter">1 USD Equals</span>
                                        <div className="flex items-center gap-2">
                                            <input
                                                type="number"
                                                className="bg-transparent border-none focus:outline-none text-2xl font-medium text-[#1B2559] w-28"
                                                value={exchangeRate}
                                                onChange={(e) => setExchangeRate(e.target.value)}
                                            />
                                            <span className="text-2xl font-medium text-slate-700">៛</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                disabled={isSaving}
                                className={cn(
                                    "h-[88px] font-medium rounded-lg transition-all flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-xs shadow-2xl group cursor-pointer",
                                    showSuccess
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="card-premium p-6 space-y-4 border border-[#E0E5F2]/50">
                            <div className="p-3 bg-orange-500/10 rounded-lg w-fit text-orange-400 mb-2">
                                <Bell className="w-5 h-5" />
                            </div>
                            <h3 className="text-base font-medium text-[#1B2559]">Notifications</h3>
                            ...
                            <div className="flex items-center justify-between pt-2">
                                <span className="text-[10px] font-medium text-[#A3AED0] uppercase tracking-widest">Email Alerts</span>
                        ...
                        <div className="card-premium p-6 space-y-4 border border-[#E0E5F2]/50">
                            <div className="p-3 bg-indigo-500/10 rounded-lg w-fit text-indigo-400 mb-2">
                                <Database className="w-5 h-5" />
                            </div>
                            <h3 className="text-base font-medium text-[#1B2559]">Data Governance</h3>
                            <p className="text-xs text-[#A3AED0] font-medium">Export clinical data or manage automatic cloud backup frequency.</p>
                            <button className="text-[10px] font-medium text-primary uppercase tracking-widest hover:underline pt-2 cursor-pointer">Export Ledger (CSV)</button>
                        </div>

                        <div className="card-premium p-6 space-y-4 border border-[#E0E5F2]/50">
                            <div className="p-3 bg-pink-500/10 rounded-lg w-fit text-pink-400 mb-2">
                                <Printer className="w-5 h-5" />
                            </div>
                            <h3 className="text-base font-medium text-[#1B2559]">Invoice Theme</h3>
                            ...
                            <div className="flex items-center gap-4 pt-2">
                                ...
                                />
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-medium text-[#A3AED0] uppercase tracking-widest">Selected Color</span>
                                    <span className="text-sm font-medium text-[#1B2559] uppercase">{invoiceColor}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="card-premium p-6 shadow-2xl flex flex-col h-full border border-[#E0E5F2]/50">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-xl font-medium text-white uppercase tracking-tight">Security</h2>
                        </div>
                        ...
                        <div className="space-y-6 flex-1">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-white">Financial Logs</p>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-white">Staff Settings</p>
                        ...
                        <div className="mt-10 pt-8 border-t border-white/5 flex items-center gap-3 text-slate-600">
                            ...
                            <span className="text-[10px] font-medium uppercase tracking-widest">Internal Build v2.4.0</span>
                        </div>
                                        ...
                                        {!isAuthenticated ? (
                                            ...
                                            <div className="space-y-6">
                                                <div className="text-center space-y-2">
                                                    ...
                                                    <h4 className="text-xl font-medium text-white">Admin Access Required</h4>
                                                ...
                                                <div className="space-y-4">
                                                    <input
                                                        ...
                                                        className={cn(
                                                            "w-full bg-slate-900 border text-center text-2xl font-medium text-white p-4 rounded-lg focus:outline-none transition-all",
                                                        ...
                                                        autoFocus
                                                    />
                                                    {authError && <p className="text-center text-xs font-medium text-red-400 uppercase tracking-widest">Invalid Security PIN</p>}

                                                    <button
                                                        onClick={handleLogin}
                                                        className="w-full bg-primary hover:bg-blue-600 text-white font-medium py-4 rounded-lg uppercase tracking-[0.2em] text-xs transition-all active:scale-95 shadow-lg shadow-primary/20"
                                                    >
                                                        Unlock Module
                                                    </button>
                                                </div>
                                            ...
                                            <div className="space-y-6">
                                                {isLoadingData ? (
                                                    <div className="flex flex-col items-center justify-center py-12 gap-4">
                                                        ...
                                                        <p className="text-slate-500 text-xs font-medium uppercase tracking-widest">Loading Secure Data...</p>
                                                    </div>
                                                    ...
                                                    <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                                                        {financialLogs.map((log, idx) => (
                                                            <div key={log.id} className="bg-slate-900/50 border border-white/5 rounded-lg overflow-hidden hover:border-white/10 transition-all group">
                                                                {/* Invoice Header */}
                                                                <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 px-5 py-3 border-b border-white/5 flex items-center justify-between">
                                                                    <div className="flex items-center gap-3">
                                                                        <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                                                                            <span className="text-xs font-medium text-primary">#{financialLogs.length - idx}</span>
                                                                        </div>
                                                                        <div>
                                                                            <p className="text-xs font-medium text-white">{log.patients?.name || 'Unknown Patient'}</p>
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        <span className="px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-[9px] font-medium text-emerald-400 uppercase tracking-wider">
                                                                            Paid
                                                                        </span>
                                                                ...
                                                                <div className="p-5 space-y-3">
                                                                    ...
                                                                    <div className="flex items-start justify-between">
                                                                        <div className="flex-1">
                                                                            <p className="text-[10px] text-slate-500 font-medium uppercase tracking-widest mb-1">Service</p>
                                                                            <p className="text-sm font-medium text-white capitalize">{log.treatments || log.description || 'General Service'}</p>
                                                                        </div>
                                                                        <div className="text-right">
                                                                            <p className="text-[10px] text-slate-500 font-medium uppercase tracking-widest mb-1">Total</p>
                                                                            <p className="text-sm font-medium text-white">${Number(log.total_price || log.amount_paid).toLocaleString()}</p>
                                                                        </div>
                                                                    </div>

                                                                    {/* Payment Breakdown */}
                                                                    <div className="pt-3 border-t border-white/5">
                                                                        <p className="text-[9px] text-slate-500 font-medium uppercase tracking-widest mb-2">Payment Methods</p>
                                                                        <div className="grid grid-cols-3 gap-2">
                                                                            {Number(log.paid_aba) > 0 && (
                                                                                <div className="bg-blue-500/5 border border-blue-500/10 rounded-lg px-3 py-2">
                                                                                    <p className="text-[8px] text-blue-400 font-medium uppercase tracking-wider mb-0.5">ABA Bank</p>
                                                                                    <p className="text-xs font-medium text-blue-300">${Number(log.paid_aba).toLocaleString()}</p>
                                                                                </div>
                                                                            )}
                                                                            {Number(log.paid_cash_usd) > 0 && (
                                                                                <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-lg px-3 py-2">
                                                                                    <p className="text-[8px] text-emerald-400 font-medium uppercase tracking-wider mb-0.5">USD Cash</p>
                                                                                    <p className="text-xs font-medium text-emerald-300">${Number(log.paid_cash_usd).toLocaleString()}</p>
                                                                                </div>
                                                                            )}
                                                                            {Number(log.paid_cash_khr) > 0 && (
                                                                                <div className="bg-amber-500/5 border border-amber-500/10 rounded-lg px-3 py-2">
                                                                                    <p className="text-[8px] text-amber-400 font-medium uppercase tracking-wider mb-0.5">KHR Cash</p>
                                                                                    <p className="text-xs font-medium text-amber-300">៛{Number(log.paid_cash_khr).toLocaleString()}</p>
                                                                                </div>
                                                                            )}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="pt-2 flex items-center justify-between">
                                                                        ...
                                                                        <Link
                                                                            ...
                                                                            className="text-[9px] font-medium text-primary hover:text-blue-400 uppercase tracking-wider transition-colors flex items-center gap-1 opacity-0 group-hover:opacity-100"
                                                                        >
