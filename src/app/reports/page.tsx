...
export default function ReportsPage() {
    ...
    async function fetchStats() {
        ...
        setStats({
            ...
            periodRevenue: stats.periodRevenue, // Use the calculated value from above
    ...
    return (
        <div className="space-y-8 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard
                    title={
                        timeframe === '365' ? `Period Revenue (${selectedYear})` :
                            timeframe === '180' ? 'Semi-Annual Revenue' :
                                timeframe === '90' ? 'Quarterly Revenue' :
                                    timeframe === '30' ? 'Monthly Revenue' :
                                        timeframe === '7' ? 'Weekly Revenue' : 'Today\'s Revenue'
                    }
                ...
                />
                <StatCard
                    title={timeframe === '30' ? "Monthly Income" : timeframe === '1' ? "Daily Income" : "Cycle Income"}
