        ...
        <div className="max-w-[1440px] mx-auto px-7 pt-1 pb-6 space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="flex items-center justify-between shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-3xl font-black text-[#1B2559] tracking-tight truncate max-w-[400px]">
                            {formData.productName || "Item Details"}
                        </h1>
                        <span className="text-[11px] font-bold text-[#A3AED0] uppercase tracking-[0.2em]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="bg-white rounded-[24px] border border-[#E0E5F2] px-8 py-5 shadow-sm space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
                            {/* Vendor Section Title */}
                            <div className="md:col-span-3">
                                <h2 className="text-xl font-black text-[#1B2559] flex items-center gap-2 font-kantumruy">
                                                        ...
                                                        {dbCategories
                                                            ...
                                                            .map((cat) => (
                                                                <button
                                                                    ...
                                                                    className={cn("w-full px-5 py-2.5 text-left text-[12px] font-bold transition-colors hover:bg-[#F4F7FE]", formData.category === cat ? "text-[#4318FF] bg-[#F4F7FE]/50" : "text-[#1B2559]")}
                                                                >
                                                                    {cat}
                                                                </button>
                                                            ))}
                    ...
                    <div className="bg-white rounded-[24px] border border-[#E0E5F2] px-8 py-6 shadow-sm">
                        <h2 className="text-xl font-black text-[#1B2559] flex items-center gap-2 font-kantumruy mb-6">
                            <Calendar className="w-5 h-5 text-[#4318FF]" />
                            Stock History
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="flex items-center gap-5 p-4 rounded-2xl bg-[#F4F7FE]/30 border border-[#E0E5F2]/50 hover:border-[#4318FF]/20 transition-all group">
                                <div className="w-12 h-12 rounded-xl bg-white border border-[#E0E5F2] flex items-center justify-center group-hover:shadow-sm transition-all">
                                    <ArrowUpRight className="w-6 h-6 text-[#19D5C5]" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-[#A3AED0] uppercase tracking-widest mb-0.5">Last Stock In</p>
                            ...
                            <div className="flex items-center gap-5 p-4 rounded-2xl bg-[#F4F7FE]/30 border border-[#E0E5F2]/50 hover:border-[#4318FF]/20 transition-all group">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-[#A3AED0] uppercase tracking-widest mb-0.5">Last Stock Out</p>
                                    <h3 className="text-xl font-black text-[#1B2559]">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white rounded-[24px] border border-[#E0E5F2] p-8 shadow-sm h-full flex flex-col">
                        ...
                        {/* Usage Value Display */}
                        <div className="mb-10">
                            <p className="text-[11px] font-black text-[#A3AED0] uppercase tracking-widest mb-2">Total Units Used</p>
                            <div className="flex items-baseline gap-2">
                                <h3 className="text-5xl font-black text-[#1B2559] tracking-tighter">
                                    {usageStats.reduce((a, b) => a + b, 0).toLocaleString()}
                                </h3>
                                <span className="text-[14px] font-bold text-[#4318FF]">{formData.unit || "Units"}</span>
                            </div>
                        </div>
                            ...
                            {usageStats.map((val, i) => {
                                ...
                                return (
                                    <div key={i} className="flex-1 flex flex-col items-center gap-3">
                                        <div
                                            className="w-full bg-[#F4F7FE] rounded-xl relative group overflow-hidden transition-all duration-700 ease-out"
                                            style={{ height: `100%`, maxHeight: `${height}%` }}
                                        >
                                            <div className="absolute inset-0 bg-[#4318FF]/10 scale-0 group-hover:scale-100 transition-transform duration-300" />
                                            <div className="absolute inset-x-0 bottom-0 bg-[#4318FF]/90 h-[4px] opacity-0 group-hover:opacity-100 transition-all duration-300" />
                                            {/* Value on Hover */}
                                            <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-black text-[#4318FF] opacity-0 group-hover:opacity-100 transition-all duration-300">
                                                {val}
                                            </div>
                                        </div>
                                        <span className="text-[8px] font-black text-[#A3AED0] uppercase tracking-tighter">
                        ...
                        {/* Timeframe Toggle */}
                        <div className="bg-[#F4F7FE]/50 p-1.5 rounded-2xl flex gap-1">
