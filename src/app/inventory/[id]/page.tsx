    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <Loader2 className="w-10 h-10 animate-spin text-[#4318FF]" />
            </div>
        );
    }
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pt-2">
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex flex-col gap-0.5">
                        <p className="text-[10px] font-black text-[#A3AED0] uppercase tracking-widest pl-0.5">Product Profile</p>
                        <h1 className="text-4xl font-black text-[#1B2559] tracking-tight truncate max-w-[500px] leading-none">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        disabled={deleting}
                        className="flex items-center gap-2 px-6 py-3 rounded-2xl text-[11px] font-black uppercase text-[#EE5D50] hover:bg-[#EE5D50]/5 transition-all"
                    >
                    ...
                    <button
                        ...
                        disabled={saving}
                        className="bg-[#4318FF] px-8 py-3 rounded-2xl text-[11px] font-black text-white hover:bg-[#3311E0] transition-all shadow-md shadow-[#4318FF]/20 uppercase tracking-widest flex items-center gap-2"
                    >
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="bg-white rounded-[24px] border border-[#E0E5F2] p-8 shadow-sm">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
                        <div className="md:col-span-3 mb-2">
                            <h2 className="text-2xl font-black text-[#1B2559] flex items-center gap-2 font-kantumruy tracking-tight">
                                <Building2 className="w-6 h-6 text-[#4318FF]" />
                                Vendor Information
                            </h2>
                        </div>
                ...
                <div className="bg-white rounded-[24px] border border-[#E0E5F2] p-8 shadow-sm">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-x-8 gap-y-6">
                        <div className="md:col-span-4 mb-2">
                            <h2 className="text-2xl font-black text-[#1B2559] flex items-center gap-2 font-kantumruy tracking-tight">
                                <Package className="w-6 h-6 text-[#4318FF]" />
                                Product Details
                            </h2>
                        </div>
                                                ...
                                                {dbCategories
                                                    ...
                                                    .map((cat) => (
                                                        <button
                                                            ...
                                                            className={cn("w-full px-5 py-2.5 text-left text-[11px] font-black uppercase tracking-widest transition-colors hover:bg-[#F4F7FE]", formData.category === cat ? "text-[#4318FF] bg-[#F4F7FE]/50" : "text-[#1B2559]")}
                                                        >
                                                            {cat}
                                                        </button>
                                                    ))}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-black text-[#A3AED0] uppercase tracking-widest pl-1">SKU</label>
                            <div className="relative bg-[#F4F7FE]/50 rounded-xl px-5 py-3 flex items-center gap-3">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative bg-[#F4F7FE]/50 rounded-xl px-5 py-3 flex items-center gap-3">
                                ...
                                <input
                                    ...
                                    className="bg-transparent border-none p-0 text-[#1B2559] text-[12px] font-bold outline-none w-full"
                                />
                            </div>
                        </div>
                            ...
                            <div className="relative">
                                ...
                                {isUnitDropdownOpen && (
                                    <>
                                        ...
                                        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-[#E0E5F2] rounded-xl shadow-xl z-50 overflow-hidden">
                                            <div className="max-h-[200px] overflow-y-auto">
                                                {dbUnits.filter(u => !formData.unit || u.toLowerCase().includes(formData.unit.toLowerCase())).map(u => (
                                                    <button key={u} type="button" onClick={() => { setFormData({ ...formData, unit: u }); setIsUnitDropdownOpen(false); }} className={cn("w-full px-5 py-2.5 text-left text-[12px] font-bold", formData.unit === u ? "text-[#4318FF] bg-[#F4F7FE]/50" : "text-[#1B2559] hover:bg-[#F4F7FE]")}>
                                                        {u}
                                                    </button>
                                                ))}
                                            </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative bg-[#F4F7FE]/50 rounded-xl px-5 py-3 flex items-center gap-2">
                                ...
                                <input type="number" value={formData.buyPrice} onChange={(e) => setFormData({ ...formData, buyPrice: parseFloat(e.target.value) || 0 })} className="bg-transparent border-none p-0 text-[13px] font-black text-[#1B2559] outline-none w-full" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative bg-[#F4F7FE]/50 rounded-xl px-5 py-3 flex items-center gap-2">
                                ...
                                <input type="number" value={formData.sellPrice} onChange={(e) => setFormData({ ...formData, sellPrice: parseFloat(e.target.value) || 0 })} className="bg-transparent border-none p-0 text-[13px] font-black text-[#1B2559] outline-none w-full" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-6 flex flex-col">
                        <div className="bg-white rounded-[24px] border border-[#E0E5F2] p-6 shadow-sm flex-1">
                            <div className="flex items-center justify-between gap-4 mb-4">
                                <h2 className="text-[20px] font-black text-[#1B2559] flex items-center gap-2 font-kantumruy tracking-tight">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        showNote ? "text-[#4318FF]" : "text-[#A3AED0] hover:text-[#1B2559]"
                                    )}
                                >
                            ...
                            <div className="flex-1 space-y-3">
                                <div className="space-y-3">
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-black text-[#A3AED0] uppercase tracking-widest pl-1">Amount</label>
                                        <div className="relative bg-[#F4F7FE]/50 rounded-xl px-4 py-2 flex items-center gap-3 border border-transparent focus-within:ring-2 focus-within:ring-[#4318FF]/10 transition-all">
                                            <Layers className="w-4 h-4 text-[#4318FF]" />
                                            <input
                                                type="number"
                                                value={adjQty || ""}
                                                ...
                                                placeholder="e.g. 10"
                                                className="bg-transparent border-none p-0 text-[12px] font-bold text-[#1B2559] outline-none placeholder:text-[#A3AED0] w-full"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    {showNote && (
                                        <div className="space-y-1.5 animate-in fade-in slide-in-from-top-1 duration-200">
                                            <label className="text-[10px] font-black text-[#A3AED0] uppercase tracking-widest pl-1">Reason / Note</label>
                                            <textarea
                                                value={adjNote}
                                                onChange={(e) => setAdjNote(e.target.value)}
                                                placeholder="e.g. Withdrawing 22 boxes..."
                                                className="w-full bg-[#F4F7FE]/50 border-none rounded-xl px-4 py-2 text-[12px] font-bold text-[#1B2559] outline-none min-h-[60px] resize-none placeholder:text-[#A3AED0] focus:ring-1 focus:ring-[#4318FF]/10 transition-all"
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div className="flex gap-2.5">
                                        <button
                                            ...
                                            className="flex-1 bg-[#19D5C5] text-white py-2.5 rounded-xl font-black text-[10px] uppercase tracking-wider flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-md shadow-[#19D5C5]/20 disabled:opacity-50 disabled:scale-100"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 bg-[#EE5D50] text-white py-2.5 rounded-xl font-black text-[10px] uppercase tracking-wider flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-md shadow-[#EE5D50]/20 disabled:opacity-50 disabled:scale-100"
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-3 mt-3">
                                    <div className="flex items-center gap-3 p-3 rounded-[20px] bg-[#F4F7FE]/30 border border-[#E0E5F2]/50 hover:border-[#4318FF]/20 transition-all group">
                                        ...
                                        <div className="flex-1 truncate">
                                            <p className="text-[8px] font-black text-[#A3AED0] uppercase tracking-widest mb-0.5">Last In</p>
                                            <h3 className="text-[11px] font-black text-[#1B2559] truncate leading-tight">
                                    ...
                                    <div className="flex items-center gap-3 p-3 rounded-[20px] bg-[#F4F7FE]/30 border border-[#E0E5F2]/50 hover:border-[#4318FF]/20 transition-all group">
                                        ...
                                        <div className="flex-1 truncate">
                                            <p className="text-[8px] font-black text-[#A3AED0] uppercase tracking-widest mb-0.5">Last Out</p>
                                            <h3 className="text-[11px] font-black text-[#1B2559] truncate leading-tight">
                                    ...
                                    <div className="flex items-center gap-3 p-3 rounded-[20px] bg-[#F4F7FE]/30 border border-[#E0E5F2]/50 hover:border-[#4318FF]/20 transition-all group">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-[8px] font-black text-[#A3AED0] uppercase tracking-widest mb-0.5">Qty</p>
                                            <div className="flex items-baseline gap-1 leading-tight">
                                                <h3 className="text-[12px] font-black text-[#1B2559]">{formData.quantity}</h3>
                                                <span className="text-[8px] font-bold text-[#A3AED0] uppercase">{formData.unit}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2.5 p-3 rounded-[20px] bg-[#F4F7FE]/30 border border-[#E0E5F2]/50 hover:border-[#4318FF]/20 transition-all group">
                                        <div className="w-8 h-8 rounded-full bg-white border border-[#E0E5F2] flex items-center justify-center shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                                            <div className={cn(
                                        ...
                                        <div className="flex-1">
                                            <p className="text-[8px] font-black text-[#A3AED0] uppercase tracking-widest mb-0.5">Health</p>
                                            <h3 className={cn(
                    ...
                    <div className="lg:col-span-6 flex flex-col">
                        <div className="bg-white rounded-[24px] border border-[#E0E5F2] p-6 shadow-sm flex-1">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                ...
                                <div className="bg-[#F4F7FE]/50 p-0.5 rounded-xl flex gap-1 w-full md:w-36">
                                    {(['1m', '3m', '6m'] as const).map((t) => (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                timeframe === t ? "bg-white text-[#4318FF] shadow-sm" : "text-[#A3AED0] hover:text-[#1B2559]"
                                            )}
                                        >
                                            {t}
                                        </button>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between gap-3 p-4 rounded-[20px] bg-[#F4F7FE]/30 border border-[#E0E5F2]/50">
                                    <div>
                                        <p className="text-[9px] font-black text-[#A3AED0] uppercase tracking-widest mb-1">Consumption</p>
                                        <div className="flex items-baseline gap-1.5">
                                            <h3 className="text-2xl font-black text-[#1B2559] tracking-tighter">
                                                {totalConsumption.toLocaleString()}
                                            </h3>
                                            <span className="text-[10px] font-bold text-[#A3AED0] uppercase">{formData.unit}</span>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[9px] font-black text-[#A3AED0] uppercase tracking-widest mb-1">Trend</p>
                                        <div className={cn(
                                    ...
                                    {usageData.map((val, i) => {
                                        ...
                                        return (
                                            <div key={i} className="flex-1 flex flex-col items-center gap-2 h-full justify-end">
                                                ...
                                                >
                                                    <div className="absolute inset-x-0 bottom-0 bg-[#4318FF] h-1 transition-all duration-500 rounded-t-full" />
                                                    <div className="absolute -top-7 left-1/2 -translate-x-1/2 bg-[#1B2559] text-white px-2 py-1 rounded-md text-[8px] font-black opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none shadow-lg whitespace-nowrap">
                                                        {val} {formData.unit}
                                                    </div>
                                                </div>
                                                <span className="text-[7px] font-black text-[#A3AED0] uppercase tracking-tight">
                                                    {usageLabels[i]}
                                                </span>
                                            </div>
                                        );
