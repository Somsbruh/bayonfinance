...
export default function Sidebar() {
    ...
    return (
        <div
            className={cn(
                "h-screen sticky top-0 shrink-0 z-[100] transition-all duration-500 ease-in-out relative",
                isCollapsed ? "w-20" : "w-[264px]"
            )}
        >
            <div className="w-full h-full bg-white border-r border-[#E0E5F2] flex flex-col shadow-[14px_17px_40px_4px_rgba(112,144,176,0.08)] print:hidden no-scrollbar overflow-hidden">
                {/* Header / Logo */}
                <div className={cn(
